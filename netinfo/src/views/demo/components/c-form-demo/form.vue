        ...
        njs-form(:label-position='labelPosition', label-width='190px', :model='formLabelAlign' service="U15154545" submitText="提交一个" resetText="reset" @submit-before="submitBefore" ref="myForm" @submit-fail="submitFail" size="small" :rules="rules")
          ...
          njs-form-item(label='放大镜示例' prop="fangdajing")
            ...
            data-label="ROLE_NAME,MODIFY_OPER"
              ...
              njs-column(prop="ROLE_NAME" label="角色名称")
              njs-column(prop="ROLE_STAT" type="state" label="状态" dict="APPEAL_STAT" :state-map="{'1': 'warning', '2': 'success', '3':'danger'}" hide)
              njs-column(prop="MODIFY_OPER" label="最后修改人")
          ...
          template(slot="button")
            njs-button(@click="mySubmit") 自定义按钮1
            njs-button(@click="getAttr") 自定义按钮2
